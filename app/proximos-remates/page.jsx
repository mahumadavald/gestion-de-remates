  ...
  return (
    <>
      ...
      <div className="topbar">
        <a className="topbar-brand" href="https://pecker.cl">
          ...
          <span className="topbar-name">Pecker</span>
        </a>
      ...
      <div className="footer">
        Powered by <strong>Pecker</strong> · pecker.cl · Plataforma de gestión de remates
      </div>
    </>
  );
}
