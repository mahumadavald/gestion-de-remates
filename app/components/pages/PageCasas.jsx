        ...
        {dbLicencias.map((casa, idx) => (
          <div key={casa.id} style={{ background: "var(--s2)", border: "1px solid var(--b1)", borderRadius: 12, overflow: "hidden" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1rem 1.2rem", borderBottom: "1px solid var(--b1)" }}>
              <label style={{ width: 48, height: 48, borderRadius: 10, background: "rgba(6,182,212,.08)", border: "1px solid rgba(6,182,212,.15)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, overflow: "hidden", cursor: "pointer", position: "relative" }}
                onMouseEnter={e => e.currentTarget.style.borderColor = "rgba(6,182,212,.5)"}
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: ".5rem" }}>
                  <span style={{ fontSize: ".62rem", fontWeight: 700, fontFamily: "Inter,sans-serif", color: "var(--ac)", background: "rgba(6,182,212,.1)", border: "1px solid rgba(6,182,212,.2)", borderRadius: 5, padding: ".1rem .4rem" }}>#{String(idx + 1).padStart(3, "0")}</span>
            ...
            <div style={{ padding: "1rem 1.2rem", display: "flex", flexDirection: "column", gap: ".65rem" }}>
              {[
                { label: "Página de inscripción pública", url: `${BASE_URL}/participar?id=${casa.id}`, color: "var(--ac)", bg: "rgba(6,182,212,.05)", border: "rgba(6,182,212,.15)" },
      ...
      {casaModal && (
        <div className="ov" onClick={() => { setCasaModal(false); resetCasaForm(); }}>
          <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 440 }}>
            ...
            <div className="form-grid">
              <div className="fg full">
                ...
                <label style={{ display: "flex", alignItems: "center", gap: "1rem", padding: ".75rem 1rem", background: "rgba(255,255,255,.03)", border: `2px dashed ${casaForm.logoFile ? "rgba(20,184,166,.4)" : "var(--b2)"}`, borderRadius: 9, cursor: "pointer" }}>
                  <div style={{ width: 52, height: 52, borderRadius: 8, background: "rgba(6,182,212,.08)", border: "1px solid rgba(6,182,212,.15)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, overflow: "hidden" }}>
                    {casaForm.logoUrl
            ...
            <div style={{ marginTop: "1rem", padding: ".75rem 1rem", background: "rgba(6,182,212,.05)", border: "1px solid rgba(6,182,212,.15)", borderRadius: 9, fontSize: ".73rem", color: "var(--mu2)", lineHeight: 1.6 }}>
