    ...
    <div className="auth-root">
      ...
      <div className="auth-left">
        <div style={{display:"flex",alignItems:"center",gap:"14px",marginBottom:"2.2rem"}}>
          ...
          <div style={{fontFamily:"'Poppins',sans-serif",fontWeight:800,fontSize:"1.2rem",color:"#fff"}}>Gestión de Remates</div>
        </div>
      ...
      <div className="auth-right">
        <div className="auth-card">
          <div className="auth-logo-mob">
            <svg width="32" height="32" viewBox="0 0 36 36" fill="none"><rect width="36" height="36" rx="8" fill="#0891b2"/><path d="M8 12 Q8 7 14 7 L22 7 Q30 7 30 14 Q30 19 24 20 L30 28" stroke="#fff" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/></svg>
          </div>
