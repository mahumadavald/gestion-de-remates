      ...
      <div className="main-wrap">
        ...
        {page==="devoluciones" && (()=>{
          ...
          const nombresCompradores = new Set([
            ...dbLotes.filter(l => l.postor && (!selectedRemate || l.remate_id === selectedRemate)).map(l => l.postor),
            ...liquidaciones.filter(l => !selectedRemate || l.remateId === selectedRemate).map(l => l.postor),
          ]);

          // Calcular monto exacto a devolver por postor
          const enriquecer = (p) => {
          ...
          const sinGarantia = todos.filter(p => !p.montoGar);
          ...
          <div className="page">
            ...
            {/* ── GARANTÍA CONSUMIDA (compradores sin exceso) ── */}
