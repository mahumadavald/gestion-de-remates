...
export default function LandingPage() {
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (window.scrollY > 50) {
        ...
        nav.style.borderBottomColor = 'rgba(56,178,246,.15)';
      } else {
  ...
  <a href="#" class="nav-logo">
    <svg width="32" height="32" viewBox="0 0 36 36" fill="none">
      <rect width="36" height="36" rx="8" fill="rgba(56,178,246,.15)" stroke="rgba(56,178,246,.3)" stroke-width="1"/>
      <path d="M8 12 Q8 7 14 7 L22 7 Q30 7 30 14 Q30 19 24 20 L30 28" stroke="#38B2F6" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
...
<section class="section" id="pricing">
  ...
  <div class="pricing-grid reveal">
    ...
    <div class="plan-card">
      ...
      <div style="margin:1.5rem 0 1.75rem;padding:1.25rem;background:rgba(56,178,246,.05);border:1px solid rgba(56,178,246,.12);border-radius:10px;text-align:center">
    ...
    <div class="plan-card featured">
      ...
      <div style="margin:1.5rem 0 1.75rem;padding:1.25rem;background:rgba(56,178,246,.08);border:1px solid rgba(56,178,246,.25);border-radius:10px;text-align:center">
        <div style="font-family:'Syne',sans-serif;font-size:.72rem;font-weight:700;color:var(--blue);letter-spacing:.1em;text-transform:uppercase;margin-bottom:.4rem">Precio</div>
        <div style="font-family:'Syne',sans-serif;font-size:1.4rem;font-weight:800;color:var(--white)">Consulta con nosotros</div>
        <div style="font-size:.72rem;color:var(--gray);margin-top:.3rem">Adaptado a tu volumen de remates</div>
      </div>
...
<footer>
  <div style="display:flex;align-items:center;gap:.75rem">
    <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
      <rect width="36" height="36" rx="8" fill="rgba(56,178,246,.12)" stroke="rgba(56,178,246,.2)" stroke-width="1"/>
