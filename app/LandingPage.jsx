...
export default function LandingPage() {
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (window.scrollY > 50) {
        nav.style.background = 'rgba(10,14,23,.98)';
        nav.style.borderBottomColor = 'rgba(6,182,212,.15)';
      } else {
        nav.style.background = 'rgba(10,14,23,.85)';
  ...
  <a href="#" class="nav-logo">
    <svg width="32" height="32" viewBox="0 0 36 36" fill="none">
      ...
      <path d="M4 12 Q4 5 12 5 L20 5" stroke="white" stroke-width="3.2" stroke-linecap="round" fill="none"/>
    </svg>
    <div>
...
<section class="section" id="pricing">
  ...
  <div class="pricing-grid reveal">
    ...
    <div class="plan-card">
      ...
      <div style="margin:1.5rem 0 1.75rem;padding:1.25rem;background:rgba(6,182,212,.05);border:1px solid rgba(6,182,212,.12);border-radius:10px;text-align:center">
        ...
        <div style="font-family:'Syne',sans-serif;font-size:1.4rem;font-weight:800;color:var(--white)">Consulta con nosotros</div>
    ...
    <div class="plan-card featured">
      ...
      <div style="margin:1.5rem 0 1.75rem;padding:1.25rem;background:rgba(6,182,212,.08);border:1px solid rgba(6,182,212,.25);border-radius:10px;text-align:center">
        <div style="font-family:'Syne',sans-serif;font-size:.72rem;font-weight:700;color:var(--blue);letter-spacing:.1em;text-transform:uppercase;margin-bottom:.4rem">Precio</div>
        <div style="font-family:'Syne',sans-serif;font-size:1.4rem;font-weight:800;color:var(--white)">Consulta con nosotros</div>
        <div style="font-size:.72rem;color:var(--gray);margin-top:.3rem">Adaptado a tu volumen de remates</div>
      </div>
    ...
    <div class="plan-card">
      ...
      <div style="margin:1.5rem 0 1.75rem;padding:1.25rem;background:rgba(20,184,166,.05);border:1px solid rgba(20,184,166,.15);border-radius:10px;text-align:center">
        ...
        <div style="font-family:'Syne',sans-serif;font-size:1.4rem;font-weight:800;color:var(--white)">A convenir</div>
...
<footer>
  <div style="display:flex;align-items:center;gap:.75rem">
    <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
      ...
      <path d="M4 12 Q4 5 12 5 L20 5" stroke="white" stroke-width="3" stroke-linecap="round" fill="none"/>
    </svg>
...
:root{--bg:#0a0e17;--navy:#1F2937;--blue:#06B6D4;--teal:#14B8A6;--white:#ffffff;--gray:#94a3b8;--light:#e8f4fe;--border:rgba(255,255,255,.08);}
...
.btn-nav-solid:hover{background:#22d3ee;}
...
.hero::before{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(6,182,212,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(6,182,212,.04) 1px,transparent 1px);background-size:60px 60px;animation:gridDrift 30s linear infinite;pointer-events:none;}
...
.orb1{width:600px;height:600px;background:rgba(6,182,212,.12);top:-200px;left:-100px;animation:orbFloat 8s ease-in-out infinite alternate;}
...
.btn-primary:hover{background:#22d3ee;transform:translateY(-2px);box-shadow:0 12px 30px rgba(6,182,212,.3);}
...
.feat-card:hover{border-color:rgba(6,182,212,.25);transform:translateY(-4px);background:rgba(6,182,212,.04);}
...
.plan-card.featured{background:rgba(6,182,212,.06);border-color:rgba(6,182,212,.4);transform:scale(1.03);}
...
.btn-plan-solid:hover{background:#22d3ee;}

/* CTA */
.cta-section{padding:7rem 4rem;text-align:center;position:relative;overflow:hidden;}
.cta-section::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 50%,rgba(6,182,212,.08) 0%,transparent 70%);pointer-events:none;}
